...
class DownloadData(object):
    ...
    def get_data_blp_historical(self, level_values):
        '''imports historical data from bbg api, converts to dataframe 
           level_values set to 1 if want to get rid of the extra column index ['XYZ Curncy'] title on top
           if set = 0 df MultiIndex(levels=[['EURUSD Curncy'], ['PX_OPEN', 'PX_LAST', 'PX_LOW', 'PX_HIGH']]'''
